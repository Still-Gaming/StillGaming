                        ...
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="./categories.jsp">커뮤니티<span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
                                        <li><a href="./categories.jsp">공지사항</a></li>
                                        <li><a href="./anime-details.jsp">자유게시판</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <p>After f30 days of travel across the world..</p>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="#">Shingeki npo Kyojin Season 3 Part 2</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
