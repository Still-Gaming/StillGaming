...
<%@ include file="/views/common/header.jsp" %>
	...
	<h2>FAQ</h2>
	   ...
	   <ul class="menu" >
        ...
        <div><li><a href="#content3"> 게임관련 </a></li></div>
    </ul>
...
<div id="content3">
	<div class="accordion_area" >
  <button class="btn btn_toggle">음성 채팅</button>
  <div class="content_area">
...
<div class="accordion_area" >
  <button class="btn btn_toggle">신호 시스템</button>
  <div class="content_area">
  현재 문제가 발생하여 게임에서 액트 랭크 휘장을 비활성화했습니다.
담당 부서에서 빠른 문제를 해결하기 위해 최선을 다하겠습니다.
등급별 진행 상황, 게임 기록에는 영향이 없다는 점 참고 부탁드립니다.
...
<div class="accordion_area" data-group="one">
  <button class="btn btn_toggle">배틀패스는 무엇인가요?</button>
  <div class="content_area act">
    현재 문제가 발생하여 게임에서 액트 랭크 휘장을 비활성화했습니다.
담당 부서에서 빠른 문제를 해결하기 위해 최선을 다하겠습니다.
등급별 진행 상황, 게임 기록에는 영향이 없다는 점 참고 부탁드립니다.
...
<div class="accordion_area" data-group="one">
  <button class="btn btn_toggle">	개인전 데스매치 무엇인가요?</button>
  <div class="content_area act">
